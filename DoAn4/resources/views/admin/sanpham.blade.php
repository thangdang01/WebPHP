...
.anhthang{
    background-color:rgb(174,107,72);
}           
</style>
<p style="padding: 5px; font-size:30px;"> <i class="fa fa-table" style="margin:0 10px;"></i>  Quản lý sản phẩm</p>
<div style="display:flex; justify-content: space-between;">
    <p><button class="btn btn-success" ng-click="showModal(0)" style="width: 120px;background-color:rgb(174,107,72)"> Thêm</button></p>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="name" ng-model="sp.unit_price">
                            </div>
                          <div class="form-group row">
