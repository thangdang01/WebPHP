...
@section('content')
<p style="padding: 5px; font-size:30px;"> <i class="fa fa-table" style="margin:0 10px;"></i>  Quản lý news</p>
            ...
            <table class="table table-bordered table-striped table-hover">
                ...
                <tbody>
                    <tr dir-paginate = "tt in news |filter: q| itemsPerPage: pageSize" current-page="currentPage">
                        ...
                        <td>@{{ tt.title }}</td>
                        <td>@{{ tt.content }}</td>
                        <td><img src="/img/news/@{{ tt.image }}" style='width:100px;height:100px' alt=""></td>
                        <td><button class="btn btn-info" ng-click="showModal(tt.id_new)"><i class="fas fa-edit"></i></button></td>
                        <td><button class="btn btn-danger" ng-click="deleteClick(tt.id_new)"><i class="fas fa-trash-alt"></i></button></td>
                    </tr>
                </tbody>
            </table>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="form-group row">
                            ...
                            <div style="width:100px; height:100px" id="image" class="col-sm-3">
                                <img src="/img/news/@{{tt.image}}" alt="Ảnh" style="width:100%;height:100%" ng-model="tt.image">
                            </div>
                        </div>                 
                    </div>
                </div>
